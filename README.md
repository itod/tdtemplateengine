...
In fact, TDTemplateEngine's API and usage scenarios are very similar to MGTemplateEngine. If you are in need of a template engine for Cocoa, you should definitely investigate MGTemplateEngine as well.
